...
public class Paziente extends AbstractProfilo implements Persistente<Paziente> {
	...
	public Paziente(String nome, String cognome, String username, String email, String password, String refIdLogopedista, int eta, LocalDate dataNascita, char sesso, int valuta, int punteggioTot, Map<String, Boolean> personaggiSbloccati, List<Terapia> terapie) {
