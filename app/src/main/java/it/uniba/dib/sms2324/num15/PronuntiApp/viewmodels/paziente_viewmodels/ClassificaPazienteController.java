...
public class ClassificaPazienteController {
    ...
    public List<PazienteClassifica> retrieveClassificaPazienti(String idPaziente){

        PazienteDAO pazienteDAO = new PazienteDAO();
        PersonaggioDAO personaggioDAO = new PersonaggioDAO();

        List<PazienteClassifica> pazientiClassifica = new ArrayList<>();
        pazienteDAO.getDatiLogopedistaByIdPaziente(idPaziente).thenAccept(logopedista -> {
